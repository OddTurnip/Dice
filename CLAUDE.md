...
> **Style Note:** Always use lowercase filenames for all files except `*.md` files. This ensures compatibility with case-sensitive Linux servers (e.g., `basic.html`, `dicelibrary.js`, `img/tarot/`).
